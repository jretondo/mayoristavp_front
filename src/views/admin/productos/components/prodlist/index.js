...
const ProdList = ({
    ...
    const ListarProductos = async () => {
        ...
        await axios
            .get(`${UrlNodeServer.productsDir.products}/${pagina}`, {
                params: data,
                headers: {
    ...
    const VariacionCosto = async () => {
        ...
        await axios
            .post(`${UrlNodeServer.productsDir.sub.varCost}`, data, {
                params: query,
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('user-token'),
                },
    ...
    const updateListPut = async () => {
        ...
        await axios
            .put(`${UrlNodeServer.productsDir.sub.updateList}`, data, {
                params: query,
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('user-token'),
                },
    ...
    const printPDFOfProducts = async () => {
        ...
        await axios
            .get(UrlNodeServer.productsDir.sub.pdf, {
                params: data,
    ...
    return (
        <Row style={detallesBool ? { display: 'none' } : nvaOffer ? { display: 'none' } : { display: 'block' }}>
            <Col>
                {esperar ? (
                                                ...
                                                <FormGroup>
                                                    ...
                                                    <InputGroup>
                                                        <Input
                                                            ...
                                                            onChange={(e) =>
                                                                setUpdateListProveedorValue(e.target.value)
                                                            }
                                            ...
                                            <Row>
                                                <Col md="3" style={{ marginTop: '20px', textAlign: 'center' }}>
                                                    <button
                                                        ...
                                                        style={
                                                            nvaOffer
                                                                ? { display: 'none', width: '160px', margin: 'auto' }
                                                                : { display: 'block', width: '160px', margin: 'auto' }
                                                        }
                                                        onClick={(e) => {
                                                            e.preventDefault();
                                                            printPDFOfProducts();
