...
import { Card, CardHeader, CardBody, Container, Row, Spinner, Col, Form, FormGroup } from 'reactstrap';
// core components
...
import Familia from '../../../components/subComponents/Productos/Familia';
...
const Productos = () => {
    ...
    const [familiaNvo, setFamiliaNvo] = useState('');
    ...
    const [plantFamilia, setPlantFamilia] = useState(<></>);
    ...
    const { loading, error } = UseSecureRoutes(UrlNodeServer.routesDir.sub.productos, call);
    ...
    const DetalleProducto = async () => {
        ...
        setEsperar(true);
        await axios
            .get(`${UrlNodeServer.productsDir.sub.details}/${idDetalle}`, {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('user-token'),
                },
            })
            .then((res) => {
                ...
                if (status === 200) {
                    ...
                    setMinStock(gralData.min_stock);
                                                    ...
                                                    {detallesBool ? (
                                                        <h3 className="mb-0">
                                                            ...
                                                            <span style={{ fontWeight: 'bold', color: 'red' }}>
                                                                (Última modificación:{' '}
                                                                {moment(lastUpdate).format('DD/MM/YYYY h:m')}hs)
                                                            </span>
                                                        </h3>
                                                    ) : (
                                            ...
                                            >
                                                ...
                                                <div className="pl-lg-4">
                                                    ...
                                                    <Row>
                                                        ...
                                                        <Familia
                                                            categoriaNvo={familiaNvo}
                                                            setCategoriaNvo={setFamiliaNvo}
                                                            plantCat={plantFamilia}
                                                            setPlantCat={setPlantFamilia}
                                                            listaCat={listaFamilia}
                                                            setListaCat={setListaFamilia}
                                                        />
                                                    </Row>
                                                </div>
                                                ...
                                                <h6 className="heading-small text-muted mb-4">Imagenes del producto</h6>
