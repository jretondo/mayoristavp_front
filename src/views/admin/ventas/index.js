...
const VentasModule = () => {
    ...
    const getDummy = async () => {
        ...
        await axios
            .get(UrlNodeServer.invoicesDir.sub.dummy + query, {
                headers: {
    ...
    const { loading, error } = UseSecureRoutes(UrlNodeServer.routesDir.sub.stock, call);
                ...
                <Container className="mt--7" fluid>
                    <div style={{ width: '100%' }}>
                        ...
                        <Collapse isOpen={moduleActive === 0 ? true : false}>
                            <VenderModule setValidPV={setValidPV} />
                        </Collapse>
                        ...
                        <Collapse isOpen={moduleActive === 3 ? true : false}>
                            <PagosModule setValidPV={setValidPV} />
                        </Collapse>
                    </div>
                </Container>
            </>
