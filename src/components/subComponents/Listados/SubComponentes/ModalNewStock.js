...
const ModalNewStock = ({
    ...
    const ListaPV = async () => {
        setLoading(true);
        await axios
            .get(`${UrlNodeServer.ptosVtaDir.ptosVta}`, {
                headers: {
    ...
    const StockActualLista = async () => {
        ...
        await axios
            .get(`${UrlNodeServer.stockDir.stock}${query}`, {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('user-token'),
                },
            })
    ...
    const NvoStockFunct = async () => {
        ...
        setLoading(true);
        await axios
            .post(UrlNodeServer.stockDir.stock, data, {
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('user-token'),
                },
            })
                ...
                {loading ? (
                    ...
                    <>
                        <ModalHeader toggle={() => setModal(!modal)}>
                            <h2>Nuevo Stock</h2>
                            <h2>
                                {item.name} - <span style={{ color: 'green' }}>Stock Actual: {stockAct}</span>{' '}
                            </h2>
                            <Row>
                                <Col lg="12">
                                    <FormGroup>
                        ...
                        <ModalBody>
                            <Row>
                                <Col md="4">
                                    <FormGroup>
                                        <label className="form-control-label" htmlFor="nvoStockTxt">
                                            Stock a agregar
                                        </label>
                                        <Input
                                            className="form-control-alternative"
                                        ...
                                        <Col md="6">
                                            <FormGroup>
                                                ...
                                                <Input
                                                    ...
                                                    type="text"
                                                    id="precioVtaTxt"
                                                    value={'$ ' + formatMoney(nvoStock * costo)}
                                                    disabled
                                                />
                                            </FormGroup>
                                        </Col>
